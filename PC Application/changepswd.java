...
public class changepswd extends JFrame implements ActionListener{
	...
	Connection con;
	JLabel a1,uname,pwd,quest,ans,confirm,msg,quest1,oldps,newps;
	...
	changepswd()
	{
		...
		a1=new JLabel("Enter the following details to change your password");
		...
		quest1=new JLabel("");
		oldps=new JLabel("Old Password");
		newps=new JLabel("New Password");
		...
		pwd1.setBounds(300,400,200,30);
		pwd2.setBounds(300,450,200,30);
		oldps.setBounds(150,400,150,30);
		newps.setBounds(150,450,150,30);
		...
		exit.setBounds(450,350,150,30);
		confirm.setBounds(150,580,500,30);
		change.setBounds(250,520,200,40);
		...
		oldps.setVisible(false);
		newps.setVisible(false);
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(ae.getSource()==change)
		{
			...
			try
			{
				...
				if(pwd1.getText().equals(p))
				{
					z=pwd2.getText();
					try
					{
						st=con.prepareStatement("Update login set passwd =?");
						st.setString(1,z);
					...
					confirm.setText("Password successfully changed");	
			...
			{
				System.out.print("hi" + e);
			}

			//changepswd ch=new changepswd();
		}
...
class GCanvas extends Canvas
{
  ...
  {
    Image img=null;
    try {img=ImageIO.read(new File("icon.png"));}
    catch(IOException e)
      {System.out.println("IMG_ERROR");System.exit(0);}
    g.drawImage(img,0,0,210,210,this);
  }
}
